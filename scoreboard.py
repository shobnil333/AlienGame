...
class Scoreboard():
    ...
    def prep_high_score_text(self):
        high_score_text = self.stats.high_score_text
        self.image_high_score_text = self.font.render(high_score_text, True, self.text_color, self.ai_setting.bg_color)
        self.high_score_text_rect = self.image_high_score_text.get_rect()
        self.high_score_text_rect.centerx = self.screen_rect.centerx - 120
    ...
    def prep_high_score(self):
        ...
        self.high_score_rect.centerx = self.screen_rect.centerx + 130
    ...
    def show_score(self):
        ...
        self.screen.blit(self.image_high_score_text, self.high_score_text_rect)
